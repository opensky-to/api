        ...
        public async Task<ActionResult<ApiResponse<WorldStatisticsOverview>>> GetWorldStatisticsOverview()
        {
            try
            {
                ...
                var overview = new WorldStatisticsOverview
                {
                    ...
                    TotalAirportsMSFS = await this.db.Airports.CountAsync(a => a.MSFS),
                    TotalAirportsXP11 = await this.db.Airports.CountAsync(a => a.XP11),
                    ...
                    TotalRunwaysMSFS = await this.db.Runways.CountAsync(r => r.Airport.MSFS),
                    TotalRunwaysXP11 = await this.db.Runways.CountAsync(r => r.Airport.XP11),
                    ...
                    TotalApproachesMSFS = await this.db.Approaches.CountAsync(a => a.Airport.MSFS),
                    TotalApproachesXP11 = await this.db.Approaches.CountAsync(a => a.Airport.XP11),
                    ...
                    TotalAircraftMSFS = await this.db.Aircraft.CountAsync(a => a.Type.Simulator == Simulator.MSFS),
                    TotalAircraftXP11 = await this.db.Aircraft.CountAsync(a => a.Type.Simulator == Simulator.XPlane11),
                    ...
                    TotalJobsMSFS = await this.statisticsService.GetTotalJobCount(Simulator.MSFS),
                    TotalJobsXP11 = await this.statisticsService.GetTotalJobCount(Simulator.XPlane11),
                    ...
                    CompletedFlightsMSFS = await this.statisticsService.GetTotalFlightCount(Simulator.MSFS),
                    CompletedFlightsXP11 = await this.statisticsService.GetTotalFlightCount(Simulator.XPlane11),
